        ...
        <div class="col-xl-12 col-sm-12 mb-xl-0 mb-2">
            <div class="card">
                <div class="card-header p-3 pt-2">
                    <form method="POST" action="{{ route('settings.date.store') }}">
                    @csrf
                    @method('POST')
                        <div class="pt-5">
                            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                <div class="input-group input-group-outline">
                                    <label class="form-label">Fecha de configuracion</label>
                                    <input type="date" class="form-control" name="setting_date" required>
                                </div>
                            </div>
                        </div>

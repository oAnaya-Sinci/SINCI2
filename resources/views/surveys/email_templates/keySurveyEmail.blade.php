      ...
      <tbody>
        <tr style="background-color: #F6F6F6;border-collapse:collapse">
          <td align="center" style="padding:1rem;Margin:0">
            <p style="text-align: justify; font-size: 14px;">Agradecemos su tiempo para contestar esta breve encuesta de
              4 preguntas. Con los resultados obtenidos se mejorarán los procesos y se tomarán acciones para mejorar o
              eliminar algún problema dentro de nuestro Sistema de Gestión de Calidad.</p>
            <p style="text-align: justify; font-size: 14px;">Para contestar esta encuesta debe ingresar a nuestra
              plataforma haciendo clic en el boton de abajo.</p>
              ...
              <div style="margin-bottom: 1.5rem;">
                <a style="padding: 0.5rem 4.5rem; border-radius: 0.5rem; border: 0; font-weight: 500; font-size: 15px; color: #FFF; background-color: #fe6948; text-decoration: none;" href="http://45.79.1.19:8080/" target="_blank">Encuesta SINCI</a>
              </div>
              <p style="text-align: justify; font-size: 14px;"> Una vez ahí use la siguente <em>"llave:"</em> <strong> <u>{{$body}}</u> </strong> para poder ingresar al cuestionario en cuestion. </p>
              ...
              o detalle a la brevedad posible. </p>
